const Domonkosok = () => {
  return (
<div className='dom text-white flex flex-col justify-evenly'>
  
  <h1 className="font-bold p-5 m-5 text-4xl lg:text-7xl">Domonkos rend</h1>
