  ...
  return (
    ...
    <h1 className="font-bold p-5 m-5 text-6xl lg:text-9xl">Pálos rend</h1>
        <div className="flex justify-evenly flex-col md:flex-row">
            ...
            <p>Remete Szent Pál a névadója.</p>
        ...
        <div className="flex justify-evenly flex-col md:flex-row">
            ...
            <p className="self-center">A címerükön Remete Szent Pálhoz kapcsolódó dolgok szerepelnek, mint a pálmafa, ami táplálta Pált, az oroszlán, ami Pál sírját ásta ki, és a holló egy cipővel a csőrében, ami a remeteségét fejezi ki.</p>
